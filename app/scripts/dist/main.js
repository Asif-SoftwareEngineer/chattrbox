...
var ChatMessage = function () {
  function ChatMessage(data) {
    ...
    var m = data.message,
        ...
        u = _data$user === undefined ? 'asif' : _data$user,
...
exports.ChatList = exports.ChatForm = undefined;
...
var ChatForm = exports.ChatForm = function () {
  function ChatForm(formSel, inputSel) {
    _classCallCheck(this, ChatForm);

    this.$form = (0, _jquery2.default)(formSel);
    this.$input = (0, _jquery2.default)(inputSel);
  }
...
var ChatList = exports.ChatList = function () {
  function ChatList(listSel, username) {
    _classCallCheck(this, ChatList);

    this.$list = (0, _jquery2.default)(listSel);
  ...
  _createClass(ChatList, [{
    ...
    value: function drawMessage(_ref) {
      ...
      var $message = (0, _jquery2.default)('<p>');

      $message.append((0, _jquery2.default)('<span>', {
        'class': 'timestamp',
        'data-time': t,
      ...
      (0, _jquery2.default)(this.$list).append($messageRow);
...
function registerMessageHandler(handlerFunction) {
  socket.onmessage = function (e) {
    console.log('message from wsocket', e.data);
